...
var __defProp = Object.defineProperty,
  ...
  MockerRegistry = class {
    constructor() {
      (__publicField(this, "registryByUrl", new Map()),
        __publicField(this, "registryById", new Map()));
    }
    clear() {
    ...
    register(typeOrEvent, raw, id, url, factoryOrRedirect) {
      const type =
        "object" == typeof typeOrEvent ? typeOrEvent.type : typeOrEvent;
  ...
  const finalizers = new Array(),
    ...
    mockPropertiesOf = (container, newContainer) => {
      ...
      for (const { key: property, descriptor } of getAllMockableProperties(
        ...
        const isFunction =
          type.includes("Function") && "function" == typeof value;
        if (
...
var RefTracker = class {
  constructor() {
    (__publicField(this, "idMap", new Map()),
      __publicField(this, "mockedValueMap", new Map()));
  }
  getId(value) {
...
function C(n = !1) {
  let e = "undefined" != typeof process ? process : void 0,
    i = (null == e ? void 0 : e.env) || {},
    g = (null == e ? void 0 : e.argv) || [];
  return (
    (!("NO_COLOR" in i || g.includes("--no-color")) &&
      ("FORCE_COLOR" in i ||
        g.includes("--color") ||
        "win32" === (null == e ? void 0 : e.platform) ||
        (n && "dumb" !== i.TERM) ||
        "CI" in i)) ||
    ...
    hasRequiredReactIs_development ||
      ...
      (function () {
        ...
        ((reactIs_development.ContextConsumer = ContextConsumer),
          ...
          (reactIs_development.isAsyncMode = function isAsyncMode(object) {
            return (
          ...
          (reactIs_development.isConcurrentMode = function isConcurrentMode(
            object,
          ) {
            return (
          ...
          (reactIs_development.isContextConsumer = function isContextConsumer(
            object,
          ) {
            return typeOf(object) === REACT_CONTEXT_TYPE;
          }),
          (reactIs_development.isContextProvider = function isContextProvider(
            object,
          ) {
            return typeOf(object) === REACT_PROVIDER_TYPE;
          }),
          (reactIs_development.isElement = function isElement(object) {
            return (
              "object" == typeof object &&
              null !== object &&
              object.$$typeof === REACT_ELEMENT_TYPE
          ...
          (reactIs_development.isForwardRef = function isForwardRef(object) {
            return typeOf(object) === REACT_FORWARD_REF_TYPE;
          }),
          (reactIs_development.isFragment = function isFragment(object) {
            return typeOf(object) === REACT_FRAGMENT_TYPE;
          }),
          (reactIs_development.isLazy = function isLazy(object) {
            return typeOf(object) === REACT_LAZY_TYPE;
          }),
          (reactIs_development.isMemo = function isMemo(object) {
            return typeOf(object) === REACT_MEMO_TYPE;
          }),
          (reactIs_development.isPortal = function isPortal(object) {
            return typeOf(object) === REACT_PORTAL_TYPE;
          }),
          (reactIs_development.isProfiler = function isProfiler(object) {
            return typeOf(object) === REACT_PROFILER_TYPE;
          }),
          (reactIs_development.isStrictMode = function isStrictMode(object) {
            return typeOf(object) === REACT_STRICT_MODE_TYPE;
          }),
          (reactIs_development.isSuspense = function isSuspense(object) {
            return typeOf(object) === REACT_SUSPENSE_TYPE;
          }),
          (reactIs_development.isSuspenseList = function isSuspenseList(
            object,
          ) {
            return typeOf(object) === REACT_SUSPENSE_LIST_TYPE;
          }),
          (reactIs_development.isValidElementType = function isValidElementType(
            type,
          ) {
            return (
              "string" == typeof type ||
...
function cwd() {
  return "undefined" != typeof process && "function" == typeof process.cwd
...
function createCompilerHints(options) {
  const globalThisAccessor =
    (null == options ? void 0 : options.globalThisKey) || "__vitest_mocker__";
  function _mocker() {
    return void 0 !== globalThis[globalThisAccessor]
...
function getImporter(name) {
  ...
  return (null == stack ? void 0 : stack.file) || "";
}
  ...
  ModuleMocker = class {
    constructor(interceptor, rpc2, spyOn, config) {
      (__publicField(this, "registry", new MockerRegistry()),
        __publicField(this, "queue", new Set()),
        __publicField(this, "mockedIds", new Set()),
    ...
    async importActual(id, importer) {
      ...
      return this.wrapDynamicImport(() => import(actualUrl)).then((mod) => {
        if (!resolved.optimized || void 0 === mod.default) return mod;
        const m = mod.default;
        return (null == m ? void 0 : m.__esModule)
          ? m
          : {
    ...
    async importMock(rawId, importer) {
      await this.prepare();
      const { resolvedId, resolvedUrl, redirectUrl } =
          await this.rpc.resolveMock(rawId, importer, { mock: "auto" }),
        ...
        .resolveMock(rawId, importer, {
          mock:
            "function" == typeof factoryOrOptions
              ? "factory"
              : (null == factoryOrOptions ? void 0 : factoryOrOptions.spy)
                ? "spy"
                : "auto",
        })
        .then(
    ...
    wrapDynamicImport(moduleFactory) {
      if ("function" == typeof moduleFactory) {
...
function registerModuleMocker(interceptor) {
  const mocker = new BuildModuleMocker(
    ...
    {
      resolveId: (id, importer) => rpc("resolveId", { id, importer }),
      resolveMock: (id, importer, options) =>
        rpc("resolveMock", { id, importer, options }),
      invalidate: async (ids) => rpc("invalidate", { ids }),
    },
