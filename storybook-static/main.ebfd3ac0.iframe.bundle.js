  ...
  [792],
  {
    ...
    "./node_modules/storybook/dist/_browser-chunks sync recursive"(module) {
      ...
      ((webpackEmptyContext.keys = () => []),
        (webpackEmptyContext.resolve = webpackEmptyContext),
        (webpackEmptyContext.id =
          "./node_modules/storybook/dist/_browser-chunks sync recursive"),
        (module.exports = webpackEmptyContext));
    },
    "./stories lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/stories(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.(js%7Cjsx%7Cts%7Ctsx))$"(
      ...
      var map = {
        "./Button.stories": ["./stories/Button.stories.tsx", 303],
        "./Button.stories.tsx": ["./stories/Button.stories.tsx", 303],
        "./Header.stories": ["./stories/Header.stories.tsx", 384],
        "./Header.stories.tsx": ["./stories/Header.stories.tsx", 384],
        "./Page.stories": ["./stories/Page.stories.tsx", 224, 226],
        "./Page.stories.tsx": ["./stories/Page.stories.tsx", 224, 226],
      };
    ...
    "./stories lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/stories(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.mdx)$"(
      module,
    ) {
    ...
    "./storybook-config-entry.js"(
      ...
      "use strict";
      const external_STORYBOOK_MODULE_CHANNELS_namespaceObject =
        __STORYBOOK_MODULE_CHANNELS__;
      __webpack_require__("storybook/internal/core-events");
      var csf = __webpack_require__(
      ...
      const pipeline = (x) => x(),
        importers = [
          ...
          async (path) => {
            if (
              !/^\.[\\/](?:stories(?:\/(?!\.)(?:(?:(?!(?:^|\/)\.).)*?)\/|\/|$)(?!\.)(?=.)[^/]*?\.stories\.(js|jsx|ts|tsx))$/.exec(
                path,
              )
            )
              return;
      ...
      const channel = (0,
      external_STORYBOOK_MODULE_CHANNELS_namespaceObject.createBrowserChannel)({
        page: "preview",
      });
      ...
      const preview = new external_STORYBOOK_MODULE_PREVIEW_API_.PreviewWeb(
        ...
        () => {
          const previewAnnotations = [
              ...
              __webpack_require__(
                "./node_modules/@storybook/react/dist/entry-preview-argtypes.js",
              ),
              __webpack_require__(
                "./node_modules/@storybook/react/dist/entry-preview-docs.js",
              ),
              __webpack_require__(
                "./node_modules/@storybook/nextjs/dist/preview.js",
              ),
              __webpack_require__(
                "./node_modules/@storybook/nextjs/dist/config/preview.js",
              ),
              __webpack_require__(
                "./node_modules/@storybook/addon-links/preview.js",
              ),
              __webpack_require__(
