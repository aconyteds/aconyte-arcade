/*! For license information please see 224.97bf3a1d.iframe.bundle.js.LICENSE.txt */
(self.webpackChunkaconyte_arcade = self.webpackChunkaconyte_arcade || []).push([
  [224],
  {
    "./node_modules/@storybook/testing-library/dist/esm/index.js"(
      ...
      ((a.open = ""), (a.close = ""));
      var f2 = (function p(n = !1) {
        let e = (function C(n = !1) {
      ...
      function printIteratorEntries(
        ...
        if (!current.done) {
          ...
          for (; !current.done; ) {
            ...
            ((result +=
              printer2(current.value[0], config, indentationNext, depth, refs) +
              separator +
              printer2(current.value[1], config, indentationNext, depth, refs)),
              (current = iterator.next()),
              current.done
                ? config.min || (result += ",")
      ...
      function printListItems(
        ...
        let result = "",
          isDataView = (l) => l instanceof DataView,
          length = isDataView(
      ...
      function printObjectProperties(
        ...
        let result = "",
          keys = (function getKeysOfEnumerableProperties(object, compareKeys) {
            let rawKeys = Object.keys(object),
              keys = null === compareKeys ? rawKeys : rawKeys.sort(compareKeys);
        ...
        if (keys.length > 0) {
          ...
          for (let i = 0; i < keys.length; i++) {
            let key = keys[i];
            ((result += `${indentationNext + printer2(key, config, indentationNext, depth, refs)}: ${printer2(val[key], config, indentationNext, depth, refs)}`),
              i < keys.length - 1
                ? (result += `,${config.spacingInner}`)
                : config.min || (result += ","));
          }
      ...
      var asymmetricMatcher =
        ...
        plugin$5 = {
          serialize: (val, config, indentation, depth, refs, printer2) => {
            ...
            if (
              "ArrayContaining" === stringedValue ||
              "ArrayNotContaining" === stringedValue
            )
              return ++depth > config.maxDepth
                ? `[${stringedValue}]`
                : `${stringedValue + " "}[${printListItems(val.sample, config, indentation, depth, refs, printer2)}]`;
            if (
              ...
              return ++depth > config.maxDepth
                ? `[${stringedValue}]`
                : `${stringedValue + " "}{${printObjectProperties(val.sample, config, indentation, depth, refs, printer2)}}`;
            if (
              ...
              return (
                stringedValue +
                " " +
                printer2(val.sample, config, indentation, depth, refs)
              );
          ...
          test: (val) => val && val.$$typeof === asymmetricMatcher,
        },
        OBJECT_NAMES = new Set(["DOMStringMap", "NamedNodeMap"]),
        ARRAY_REGEXP = /^(?:HTML\w*Collection|NodeList)$/;
      var plugin$4 = {
        serialize: (collection, config, indentation, depth, refs, printer2) => {
          ...
          return ++depth > config.maxDepth
            ...
            : (config.min ? "" : name + " ") +
                (OBJECT_NAMES.has(name)
                  ...
                  : `[${printListItems([...collection], config, indentation, depth, refs, printer2)}]`);
        },
        test: (val) =>
          val &&
          val.constructor &&
      ...
      function printProps(
        ...
        return keys
          .map((key) => {
            let value = props[key],
              printed = printer2(value, config, indentationNext, depth, refs);
            return (
              "string" != typeof value &&
                (printed.includes("\n") &&
                  (printed =
          ...
          .map(
            (child) =>
              ...
              ("string" == typeof child
                ...
                : printer2(child, config, indentation, depth, refs)),
          )
          .join("");
      }
      ...
      var plugin$3 = {
          serialize: (node, config, indentation, depth, refs, printer2) => {
            if (
            ...
            if (
              ...
              return (function printComment(comment, config) {
          ...
          test: (val) => {
            var _a;
            return (
              (null == (_a = val?.constructor) ? void 0 : _a.name) &&
      ...
      function printImmutableValues(
        ...
        return ++depth > config.maxDepth
          ...
          : `${getImmutableName(type) + " "}[${printIteratorValues(val.values(), config, indentation, depth, refs, printer2)}]`;
      }
          ...
          serialize: (val, config, indentation, depth, refs, printer2) =>
            val["@@__IMMUTABLE_MAP__@@"]
              ? (function printImmutableEntries(
                  ...
                  return ++depth > config.maxDepth
                    ? printAsLeaf(getImmutableName(type))
                    : `${getImmutableName(type) + " "}{${printIteratorEntries(val.entries(), config, indentation, depth, refs, printer2)}}`;
                })(
                  val,
                  config,
                  indentation,
                      ...
                      ? (function printImmutableSeq(
                          ...
                          return ++depth > config.maxDepth
                            ...
                            : val["@@__IMMUTABLE_KEYED__@@"]
                              ? `${name + " "}{${val._iter || val._object ? printIteratorEntries(val.entries(), config, indentation, depth, refs, printer2) : "…"}}`
                              : `${name + " "}[${val._iter || val._array || val._collection || val._iterable ? printIteratorValues(val.values(), config, indentation, depth, refs, printer2) : "…"}]`;
                        })(val, config, indentation, depth, refs, printer2)
      ...
      var reactIsExports = (function requireReactIs() {
        return (
          hasRequiredReactIs ||
            ((hasRequiredReactIs = 1),
            (reactIs.exports = (function requireReactIs_production_min() {
              ...
              var u,
                ...
                f3 = Symbol.for("react.profiler"),
                g = Symbol.for("react.provider"),
                h2 = Symbol.for("react.context"),
                k = Symbol.for("react.server_context"),
                l = Symbol.for("react.forward_ref"),
                m2 = Symbol.for("react.suspense"),
              ...
              return (
                ...
                (reactIs_production_min.isElement = function (a2) {
                  return (
                    "object" == typeof a2 && null !== a2 && a2.$$typeof === b
                  );
                }),
      ...
      function getChildren(arg, children = []) {
        if (Array.isArray(arg))
          for (let item of arg) getChildren(item, children);
        else null != arg && !1 !== arg && "" !== arg && children.push(arg);
        return children;
      }
      ...
      var plugin$1 = {
          serialize: (element, config, indentation, depth, refs, printer2) =>
          ...
          test: (val) => null != val && reactIsExports.isElement(val),
        },
        testSymbol =
          "function" == typeof Symbol && Symbol.for
            ...
            : 245830487;
      var dist_plugin = {
          serialize: (object, config, indentation, depth, refs, printer2) =>
            ++depth > config.maxDepth
        ...
        dist_toString = Object.prototype.toString,
      ...
      function printBasicValue(
        ...
        let toStringed = dist_toString.call(val);
      ...
      function printComplexValue(
        ...
        return "[object Arguments]" === toStringed
          ...
          : (function isToStringedArrayType(toStringed) {
            ...
            ? hitMaxDepth
              ? `[${val.constructor.name}]`
              : `${min || (!config.printBasicPrototype && "Array" === val.constructor.name) ? "" : `${val.constructor.name} `}[${printListItems(val, config, indentation, depth, refs, printer)}]`
            : "[object Map]" === toStringed
              ...
              : "[object Set]" === toStringed
                ...
                : hitMaxDepth ||
                  ...
                  : `${min || (!config.printBasicPrototype && "Object" === getConstructorName(val)) ? "" : `${getConstructorName(val)} `}{${printObjectProperties(val, config, indentation, depth, refs, printer)}}`;
      }
      function printPlugin(plugin2, val, config, indentation, depth, refs) {
        let printed;
        try {
          printed = (function isNewPlugin(plugin2) {
            return null != plugin2.serialize;
          })(plugin2)
            ? plugin2.serialize(val, config, indentation, depth, refs, printer)
            : plugin2.print(
                val,
                (valChild) =>
      ...
      function colorise(value, styleType) {
        let color =
          ansiColors[styles[styleType]] || ansiColors[styleType] || "";
        return color
          ? `[${color[0]}m${String(value)}[${color[1]}m`
          : String(value);
      }
      ...
      function inspectList(list, options, inspectItem, separator = ", ") {
        ...
        if (0 === size) return "";
        let originalLength = options.truncate,
          output = "",
          peek = "",
          truncated = "";
        for (let i = 0; i < size; i += 1) {
          let last = i + 1 === list.length,
            secondToLast = i + 2 === list.length;
          ...
          let string =
            ...
            nextLength = output.length + string.length,
            truncatedLength = nextLength + truncated.length;
          if (
            (last &&
              nextLength > originalLength &&
              output.length + truncated.length <= originalLength) ||
            (!last && !secondToLast && truncatedLength > originalLength) ||
            ((peek = last
              ? ""
              : inspectItem(list[i + 1], options) +
                (secondToLast ? "" : separator)),
            !last &&
              secondToLast &&
      ...
      function inspectProperty([key, value], options) {
        return (
          (options.truncate -= 2),
          "string" == typeof key
            ? (key = (function quoteComplexKey(key) {
                return key.match(/^[a-zA-Z_][a-zA-Z_0-9]*$/)
                  ? key
                  : JSON.stringify(key)
                      .replace(/'/g, "\\'")
                      .replace(/\\"/g, '"')
          ...
          `${key}: ${(value = options.inspect(value, options))}`
        );
      }
      function inspectTypedArray(array, options) {
        let name = ((array) =>
          "function" == typeof Buffer && array instanceof Buffer
            ? "Buffer"
        ...
        for (let i = 0; i < array.length; i++) {
          ...
          if (
            ...
            array[i] !== array.length && options.truncate <= 3)
          ) {
        ...
        return (
          nonIndexProperties.length &&
            (propertyContents = inspectList(
              nonIndexProperties.map((key) => [key, array[key]]),
              options,
              inspectProperty,
            )),
          `${name}[ ${output}${propertyContents ? `, ${propertyContents}` : ""} ]`
        );
      }
      function inspectFunction(func, options) {
        let functionType = func[Symbol.toStringTag] || "Function",
          name = func.name;
        return name
          ? options.stylize(
              `[${functionType} ${truncate(name, options.truncate - 11)}]`,
              "special",
            )
          : options.stylize(`[${functionType}]`, "special");
      }
      ...
      var dist_isNaN = Number.isNaN || ((i) => i != i);
      function inspectNumber(number, options) {
        return dist_isNaN(number)
          ? options.stylize("NaN", "number")
          : number === 1 / 0
            ? options.stylize("Infinity", "number")
            : number === -1 / 0
              ? options.stylize("-Infinity", "number")
              : 0 === number
                ? options.stylize(1 / number == 1 / 0 ? "+0" : "-0", "number")
                : options.stylize(
                    truncate(String(number), options.truncate),
                    "number",
                  );
      }
      function inspectBigInt(number, options) {
        let nums = truncate(number.toString(), options.truncate - 1);
        return ("…" !== nums && (nums += "n"), options.stylize(nums, "bigint"));
      }
      ...
      function inspectString(string, options) {
        return (
          stringEscapeChars.test(string) &&
            (string = string.replace(stringEscapeChars, dist_escape)),
          options.stylize(
      ...
      try {
        let { getPromiseDetails, kPending, kRejected } =
      ...
      function inspectObject(object, options) {
        ...
        if (
          ...
          options.seen.includes(object))
        )
          return "[Circular]";
        options.seen.push(object);
        let propertyContents = inspectList(
        ...
        let sep = "";
        return (
          propertyContents && symbolContents && (sep = ", "),
          `{ ${propertyContents}${sep}${symbolContents} }`
        );
      }
      var toStringTag =
        !!(typeof Symbol < "u" && Symbol.toStringTag) && Symbol.toStringTag;
      var errorKeys = [
        "stack",
        "line",
        "column",
      ...
      function inspectAttribute([key, value], options) {
        return (
          (options.truncate -= 3),
          value
            ? `${options.stylize(String(key), "yellow")}=${options.stylize(`"${value}"`, "string")}`
            : `${options.stylize(String(key), "yellow")}`
        );
      }
      ...
      function inspectHTML(element, options) {
        let properties = element.getAttributeNames(),
          name = element.tagName.toLowerCase(),
          head = options.stylize(`<${name}`, "special"),
          headClose = options.stylize(">", "special"),
          tail = options.stylize(`</${name}>`, "special");
        ...
        let truncate2 = options.truncate,
          children = inspectHTMLCollection(element.children, options);
        return (
          children &&
            children.length > truncate2 &&
            (children = `…(${element.children.length})`),
          `${head}${propertyContents}${headClose}${children}${tail}`
        );
      }
      var chaiInspect =
      ...
      try {
        ...
        nodeInspect = !!nodeUtil.inspect && nodeUtil.inspect.custom;
      } catch {
        nodeInspect = !1;
      }
        ...
        baseTypesMap = {
          ...
          Array: function inspectArray(array, options) {
            ...
            return (
              ...
              `[ ${listContents}${propertyContents ? `, ${propertyContents}` : ""} ]`
            );
          },
          Date: function inspectDate(dateObject, options) {
            let stringRepresentation = dateObject.toJSON();
            if (null === stringRepresentation) return "Invalid Date";
            let split = stringRepresentation.split("T"),
              date = split[0];
          ...
          RegExp: function inspectRegExp(value, options) {
            let flags = value.toString().split("/")[2],
              sourceLength = options.truncate - (2 + flags.length),
              source = value.source;
            return options.stylize(
          ...
          Arguments: function inspectArguments(args, options) {
            return 0 === args.length
              ? "Arguments[]"
              : ((options.truncate -= 13),
                `Arguments[ ${inspectList(args, options)} ]`);
          },
          ...
          DataView: () => "",
          ArrayBuffer: () => "",
          Error: function inspectObject2(error, options) {
            let properties = Object.getOwnPropertyNames(error).filter(
                (key) => -1 === errorKeys.indexOf(key),
              ),
              name = error.name;
      ...
      function inspect(value, opts = {}) {
        let options = (function normaliseOptions(
            {
              showHidden = !1,
              depth = 2,
              colors = !1,
          ...
          { customInspect } = options,
          type = null === value ? "null" : typeof value;
        if (
          ("object" === type && (type = toString2.call(value).slice(8, -1)),
          type in baseTypesMap)
        )
          return baseTypesMap[type](value, options);
        if (customInspect && value) {
          let output = ((value, options, type) =>
            chaiInspect in value && "function" == typeof value[chaiInspect]
              ? value[chaiInspect](options)
              : nodeInspect &&
                  nodeInspect in value &&
                  "function" == typeof value[nodeInspect]
                ? value[nodeInspect](options.depth, options)
                : "inspect" in value && "function" == typeof value.inspect
                  ? value.inspect(options.depth, options)
                  : "constructor" in value &&
                      constructorMap.has(value.constructor)
                    ? constructorMap.get(value.constructor)(value, options)
                    : stringTagMap[type]
                      ? stringTagMap[type](value, options)
                      : "")(value, options, type);
          if (output)
        ...
        let proto = !!value && Object.getPrototypeOf(value);
        return proto === Object.prototype || null === proto
          ? inspectObject(value, options)
          : value &&
              "function" == typeof HTMLElement &&
              value instanceof HTMLElement
            ? inspectHTML(value, options)
            : "constructor" in value
              ? value.constructor !== Object
                ? (function inspectClass(value, options) {
                    ...
                    return (
                      ...
                      (options.truncate -= name.length),
                      `${name}${inspectObject(value, options)}`
                    );
                  })(value, options)
                : inspectObject(value, options)
              : value === Object(value)
      ...
      function getOwnProperties(obj) {
        ...
        return (function isFinalObj(obj) {
          return (
          ...
          : ((function collectOwnProperties(obj, collector) {
              let collect =
                "function" == typeof collector
                  ? collector
                  : (key) => collector.add(key);
      ...
      function clone(val, seen, options = defaultCloneOptions) {
        ...
        if (Array.isArray(val)) {
          for (
            out = Array.from({ length: (k = val.length) }), seen.set(val, out);
            k--;
          )
      ...
      function getType3(value) {
        ...
        if ("bigint" == typeof value) return "bigint";
        ...
        if ("symbol" == typeof value) return "symbol";
        ...
        diff_cleanupSemantic = function (diffs) {
          ...
          for (
              ...
              (function diff_cleanupSemanticLossless(diffs) {
                ...
                for (; pointer < diffs.length - 1; ) {
                  if (
                    ...
                    if (commonOffset) {
                      let commonString = edit.substring(
                    ...
                    diffs[pointer - 1][1] !== bestEquality1 &&
                      (bestEquality1
                        ? (diffs[pointer - 1][1] = bestEquality1)
                        : (diffs.splice(pointer - 1, 1), pointer--),
            ...
            if (-1 === diffs[pointer - 1][0] && 1 === diffs[pointer][0]) {
              ...
              (overlap_length1 >= overlap_length2
                ? (overlap_length1 >= deletion.length / 2 ||
                    overlap_length1 >= insertion.length / 2) &&
                  (diffs.splice(
                    pointer,
                    0,
                    new Diff(0, insertion.substring(0, overlap_length1)),
                  ),
                ...
                : (overlap_length2 >= deletion.length / 2 ||
                  ...
                  (diffs.splice(
                    pointer,
                    0,
                    new Diff(0, deletion.substring(0, overlap_length2)),
                  ),
                  (diffs[pointer - 1][0] = 1),
              ...
              (count_delete + count_insert > 1
                ? (0 !== count_delete &&
                    ...
                    0 !== commonlength &&
                      ...
                      0 === diffs[pointer - count_delete - count_insert - 1][0]
                        ? (diffs[
                        ...
                        : (diffs.splice(
                            0,
                            0,
                            new Diff(0, text_insert.substring(0, commonlength)),
                          ),
                          pointer++),
      ...
      function diff_cleanupSemanticScore_(one, two) {
        ...
        let char1 = one.charAt(one.length - 1),
          ...
          nonAlphaNumeric2 = char2.match(nonAlphaNumericRegex_),
          whitespace1 = nonAlphaNumeric1 && char1.match(whitespaceRegex_),
          whitespace2 = nonAlphaNumeric2 && char2.match(whitespaceRegex_),
          lineBreak1 = whitespace1 && char1.match(linebreakRegex_),
          lineBreak2 = whitespace2 && char2.match(linebreakRegex_),
          blankLine1 = lineBreak1 && one.match(blanklineEndRegex_),
          blankLine2 = lineBreak2 && two.match(blanklineStartRegex_);
        return blankLine1 || blankLine2
          ? 5
          : lineBreak1 || lineBreak2
            ? 4
            : nonAlphaNumeric1 && !whitespace1 && whitespace2
              ? 3
              : whitespace1 || whitespace2
                ? 2
                : nonAlphaNumeric1 || nonAlphaNumeric2
                  ? 1
                  : 0;
      }
      var hasRequiredBuild,
        build = {};
      var diffSequences = (function getDefaultExportFromCjs(x) {
        return x &&
          x.__esModule &&
        ...
        (function requireBuild() {
          ...
          ((hasRequiredBuild = 1),
            Object.defineProperty(build, "__esModule", { value: !0 }),
            (build.default = function diffSequence(
              aLength,
              bLength,
              isCommon,
              foundSubsequence,
              ...
              let nCommonF = countCommonItemsF(
                0,
                aLength,
                0,
                bLength,
              ...
              if (
                ...
                aLength !== nCommonF || bLength !== nCommonF)
              ) {
                let aStart = nCommonF,
                  bStart = nCommonF,
                  nCommonR = countCommonItemsR(
                    aStart,
                    aLength - 1,
                    bStart,
                    bLength - 1,
          ...
          let pkg = "diff-sequences",
            NOT_YET_SET = 0,
            countCommonItemsF = (aIndex, aEnd, bIndex, bEnd, isCommon) => {
              let nCommon = 0;
              for (
                ;
                aIndex < aEnd && bIndex < bEnd && isCommon(aIndex, bIndex);
              )
            ...
            extendOverlappablePathsF = (
              ...
              let bF = bStart - aStart,
                ...
                kMinOverlapF = -baDeltaLength - (d - 1),
                kMaxOverlapF = d - 1 - baDeltaLength,
                aIndexPrev1 = NOT_YET_SET,
                nF = d < iMaxF ? d : iMaxF;
              for (let iF = 0, kF = -d; iF <= nF; iF += 1, kF += 2) {
                let insert =
                    0 === iF || (iF !== d && aIndexPrev1 < aIndexesF[iF]),
                  aLastPrev = insert ? aIndexesF[iF] : aIndexPrev1,
                  aFirst = insert ? aLastPrev : aLastPrev + 1,
                  bFirst = bF + aFirst - kF,
                  nCommonF = countCommonItemsF(
                    aFirst + 1,
                    aEnd,
                    bFirst + 1,
                    bEnd,
                ...
                if (
                  ((aIndexPrev1 = aIndexesF[iF]),
                  (aIndexesF[iF] = aLast),
                  kMinOverlapF <= kF && kF <= kMaxOverlapF)
                ) {
                  let iR = (d - 1 - (kF + baDeltaLength)) / 2;
                  if (iR <= iMaxR && aIndexesR[iR] - 1 <= aLast) {
                    let bLastPrev = bF + aLastPrev - (insert ? kF + 1 : kF - 1),
                      nCommonR = countCommonItemsR(
                        aStart,
                        aLastPrev,
                        bStart,
                    ...
                    ((division.nChangePreceding = d - 1),
                      d - 1 === aEndPreceding + bEndPreceding - aStart - bStart
                    ...
                    let aStartFollowing = aLast + 1,
                      bStartFollowing = bFirst + nCommonF + 1;
                    return (
                      (division.nChangeFollowing = d - 1),
                      d - 1 === aEnd + bEnd - aStartFollowing - bStartFollowing
            ...
            extendOverlappablePathsR = (
              ...
              let bR = bEnd - aEnd,
                baDeltaLength = bEnd - bStart - (aEnd - aStart),
                kMinOverlapR = baDeltaLength - d,
                kMaxOverlapR = baDeltaLength + d,
                aIndexPrev1 = NOT_YET_SET,
                nR = d < iMaxR ? d : iMaxR;
              for (let iR = 0, kR = d; iR <= nR; iR += 1, kR -= 2) {
                let insert =
                    0 === iR || (iR !== d && aIndexesR[iR] < aIndexPrev1),
                  aLastPrev = insert ? aIndexesR[iR] : aIndexPrev1,
                  aFirst = insert ? aLastPrev : aLastPrev - 1,
                  bFirst = bR + aFirst - kR,
                  nCommonR = countCommonItemsR(
                    aStart,
                ...
                if (
                  ((aIndexPrev1 = aIndexesR[iR]),
                  (aIndexesR[iR] = aLast),
                  kMinOverlapR <= kR && kR <= kMaxOverlapR)
                ) {
                  ...
                  if (iF <= iMaxF && aLast - 1 <= aIndexesF[iF]) {
                    ...
                    if (
                      ...
                      let aStartFollowing = aLastPrev + nCommonF,
                        bStartFollowing = bLastPrev + nCommonF;
                      d - 1 === aEnd + bEnd - aStartFollowing - bStartFollowing
                        ? ((division.aStartFollowing = aEnd),
                          (division.bStartFollowing = bEnd))
                        : ((division.aStartFollowing = aStartFollowing),
            ...
            findSubsequences = (
              ...
              ((
                ...
                if (
                  ...
                  let dMin = (nChange || baDeltaLength) / 2,
                    dMax = (aLength + bLength) / 2;
                  ...
                  let dMin = ((nChange || baDeltaLength) + 1) / 2,
                    dMax = (aLength + bLength + 1) / 2,
                    d = 1;
                  for (
                    iMaxF = extendPathsF(
                      d,
              ...
              (aStart < aEndPreceding &&
                bStart < bEndPreceding &&
                findSubsequences(
                  nChangePreceding,
                  aStart,
                  aEndPreceding,
      ...
      function printDiffLine(
        ...
        return 0 !== line.length
          ...
          : " " !== indicator
            ? color(indicator)
            : isFirstOrLast && 0 !== emptyFirstOrLastLinePlaceholder.length
      ...
      function normalizeDiffOptions(options = {}) {
        return {
          ...
          compareKeys:
            ...
            compareKeys && "function" == typeof compareKeys
              ? compareKeys
              : void 0),
          contextLines:
            ((contextLines = options.contextLines),
            "number" == typeof contextLines &&
            Number.isSafeInteger(contextLines) &&
            contextLines >= 0
              ? contextLines
              : 5),
        };
        var contextLines, compareKeys;
      }
        ...
        return (
          (function printAnnotation(
            ...
            if (includeChangeCounts) {
              let aCount = String(changeCounts.a),
                bCount = String(changeCounts.b),
              ...
              ((aRest = `${aAnnotationPadding}  ${aIndicator} ${" ".repeat(Math.max(0, baCountLengthDiff))}${aCount}`),
                (bRest = `${bAnnotationPadding}  ${bIndicator} ${" ".repeat(Math.max(0, -baCountLengthDiff))}${bCount}`));
            }
            let b = `${bIndicator} ${bAnnotation}${bRest}`;
          ...
          (options.expand
            ? (function joinAlignedDiffsExpand(diffs, options) {
                return diffs
                  .map((diff2, i, diffs2) => {
                    let line = diff2[1],
                      isFirstOrLast = 0 === i || i === diffs2.length - 1;
                    switch (diff2[0]) {
                      case -1:
            ...
            : (function joinAlignedDiffsNoExpand(diffs, options) {
                let iLength = diffs.length,
                  nContextLines = options.contextLines,
                  nContextLines2 = nContextLines + nContextLines,
                  jLength = iLength,
                ...
                for (; i !== iLength; ) {
                  let iStart = i;
                  for (; i !== iLength && 0 === diffs[i][0]; ) i += 1;
                  if (iStart !== i)
                    if (0 === iStart)
                      i > nContextLines &&
                        ((jLength -= i - nContextLines),
                        (hasExcessAtStartOrEnd = !0));
                    else if (i === iLength) {
                      let n = i - iStart;
                      n > nContextLines &&
                ...
                let hasPatch =
                  0 !== nExcessesBetweenChanges || hasExcessAtStartOrEnd;
                0 !== nExcessesBetweenChanges
                  ? (jLength += nExcessesBetweenChanges + 1)
                  : hasExcessAtStartOrEnd && (jLength += 1);
                let jLast = jLength - 1,
                  lines = [],
                  jPatchMark = 0;
                hasPatch && lines.push("");
      ...
      function diffLinesUnified(aLines, bLines, options) {
        let normalizedOptions = normalizeDiffOptions(options),
          [diffs, truncated] = diffLinesRaw(
      ...
      function diffLinesRaw(aLines, bLines, options) {
        let truncate2 = options?.truncateThreshold ?? !1,
          truncateThreshold = Math.max(
          ...
          bLength = truncate2
            ...
            : bLines.length,
          truncated = aLength !== aLines.length || bLength !== bLines.length,
          diffs = [],
          aIndex = 0,
          bIndex = 0;
        for (
          diffSequences(
            aLength,
            bLength,
            (aIndex2, bIndex2) => aLines[aIndex2] === bLines[bIndex2],
            (nCommon, aCommon, bCommon) => {
              for (; aIndex !== aCommon; aIndex += 1)
                diffs.push(new Diff(-1, aLines[aIndex]));
              for (; bIndex !== bCommon; bIndex += 1)
                diffs.push(new Diff(1, bLines[bIndex]));
              for (; 0 !== nCommon; nCommon -= 1, aIndex += 1, bIndex += 1)
                diffs.push(new Diff(0, bLines[bIndex]));
            },
          );
          aIndex !== aLength;
          aIndex += 1
      ...
      var ChangeBuffer = class {
                    ...
                    (function concatenateRelevantDiffs(op, diffs, changeColor) {
                      return diffs.reduce(
                        (reduced, diff2) =>
                          ...
                          (0 === diff2[0]
                            ? diff2[1]
                            : diff2[0] === op && 0 !== diff2[1].length
                              ? changeColor(diff2[1])
                              : ""),
                        "",
                      );
                    })(this.op, this.line, this.changeColor),
                  )
          ...
          align(diff2) {
            ...
            if (string.includes("\n")) {
              ...
              substrings.forEach((substring, i) => {
                i < iLast
                  ? (this.pushSubstring(substring), this.pushLine())
                  : 0 !== substring.length && this.pushSubstring(substring);
              });
        ...
        CommonBuffer = class {
          ...
          pushDiffChangeLines(diff2) {
            let isDiffEmpty = 0 === diff2[1].length;
            ((!isDiffEmpty || this.deleteBuffer.isLineEmpty()) &&
      ...
      function diffStringsUnified(a2, b, options) {
        if (a2 !== b && 0 !== a2.length && 0 !== b.length) {
          let isMultiline = a2.includes("\n") || b.includes("\n"),
            [diffs, truncated] = diffStringsRaw(
              isMultiline ? `${a2}\n` : a2,
              isMultiline ? `${b}\n` : b,
              !0,
              options,
          ...
          if (
            (function hasCommonDiff(diffs, isMultiline) {
              ...
              return diffs.some((diff2) => 0 === diff2[0]);
            })(diffs, isMultiline)
          ) {
            let optionsNormalized = normalizeDiffOptions(options),
              lines = (function getAlignedDiffs(diffs, changeColor) {
                let deleteBuffer = new ChangeBuffer(-1, changeColor),
                  insertBuffer = new ChangeBuffer(1, changeColor),
                  commonBuffer = new CommonBuffer(deleteBuffer, insertBuffer);
                return (
                  diffs.forEach((diff2) => {
                    switch (diff2[0]) {
                      case -1:
              ...
              })(diffs, optionsNormalized.changeColor);
      ...
      function diffStringsRaw(a2, b, cleanup, options) {
        let [diffs, truncated] = (function diffStrings(a2, b, options) {
          let truncate2 = options?.truncateThreshold ?? !1,
            truncateThreshold = Math.max(
              Math.floor(options?.truncateThreshold ?? 0),
              0,
          ...
          if (truncate2) {
            let aMultipleLines = a2.includes("\n"),
              ...
              aNewLineSymbol = getNewLineSymbol(a2),
              bNewLineSymbol = getNewLineSymbol(b),
              _a = aMultipleLines
                ? `${a2.split(aNewLineSymbol, truncateThreshold).join(aNewLineSymbol)}\n`
                : a2,
              _b = bMultipleLines
          ...
          let truncated = aLength !== a2.length || bLength !== b.length,
            aIndex = 0,
            bIndex = 0,
            diffs = [];
          return (
            diffSequences(
              aLength,
              bLength,
              (aIndex2, bIndex2) => a2[aIndex2] === b[bIndex2],
              (nCommon, aCommon, bCommon) => {
                (aIndex !== aCommon &&
                  diffs.push(new Diff(-1, a2.slice(aIndex, aCommon))),
                  bIndex !== bCommon &&
                    diffs.push(new Diff(1, b.slice(bIndex, bCommon))),
                  (aIndex = aCommon + nCommon),
                  (bIndex = bCommon + nCommon),
                  diffs.push(new Diff(0, b.slice(bCommon, bIndex))));
              },
            ),
            aIndex !== aLength && diffs.push(new Diff(-1, a2.slice(aIndex))),
            bIndex !== bLength && diffs.push(new Diff(1, b.slice(bIndex))),
            [diffs, truncated]
          );
        })(a2, b, options);
      ...
      var {
        ...
        FORMAT_OPTIONS = { plugins: PLUGINS2 },
      ...
      function diff(a2, b, options) {
        ...
        let aType = getType3(a2),
          expectedType = aType,
          omitDifference = !1;
        if ("object" === aType && "function" == typeof a2.asymmetricMatch) {
          if (
            a2.$$typeof !== Symbol.for("jest.asymmetricMatcher") ||
            "function" != typeof a2.getExpectedType
          )
            return;
        ...
        if (expectedType !== getType3(b)) {
          let {
            ...
            formatOptions = getFormatOptions(FALLBACK_FORMAT_OPTIONS, options),
            aDisplay = format(a2, formatOptions),
            bDisplay = format(b, formatOptions);
        ...
        if (!omitDifference)
          switch (aType) {
            ...
            case "boolean":
            case "number":
              return (function comparePrimitive(a2, b, options) {
                let aFormat = format(a2, FORMAT_OPTIONS),
                  bFormat = format(b, FORMAT_OPTIONS);
      ...
      function compareObjects(a2, b, options) {
        let difference,
          hasThrown = !1;
        try {
          difference = getObjectsDifference(
            a2,
            b,
        ...
        let noDiffMessage = getCommonMessage(
      ...
      function getObjectsDifference(a2, b, formatOptions, options) {
        let formatOptionsZeroIndent = { ...formatOptions, indent: 0 },
          aCompare = format(a2, formatOptionsZeroIndent),
          bCompare = format(b, formatOptionsZeroIndent);
          ...
          );
        {
          let aDisplay = format(a2, formatOptions),
            bDisplay = format(b, formatOptions);
          return (function diffLinesUnified2(
            aLinesDisplay,
            bLinesDisplay,
            aLinesCompare,
            bLinesCompare,
            ...
            if (
              (isEmptyString(aLinesDisplay) &&
                isEmptyString(aLinesCompare) &&
                ((aLinesDisplay = []), (aLinesCompare = [])),
              isEmptyString(bLinesDisplay) &&
                isEmptyString(bLinesCompare) &&
                ((bLinesDisplay = []), (bLinesCompare = [])),
              aLinesDisplay.length !== aLinesCompare.length ||
                bLinesDisplay.length !== bLinesCompare.length)
            )
              return diffLinesUnified(aLinesDisplay, bLinesDisplay, options);
            let [diffs, truncated] = diffLinesRaw(
                aLinesCompare,
                bLinesCompare,
                options,
              ),
      ...
      function isAsymmetricMatcher(data) {
        return (
          "Object" === getType2(data) &&
          "function" == typeof data.asymmetricMatch
        );
      }
      function isReplaceable(obj1, obj2) {
        let obj1Type = getType2(obj1);
        return (
          obj1Type === getType2(obj2) &&
          ("Object" === obj1Type || "Array" === obj1Type)
        );
      }
      function printDiffOrStringify(expected, received, options) {
        ...
        if (
          ...
          let [diffs] = diffStringsRaw(received, expected, !0),
            hasCommonDiff2 = diffs.some((diff2) => 0 === diff2[0]),
            printLabel = (function getLabelPrinter(...strings) {
              let maxLength = strings.reduce(
                (max, string) => (string.length > max ? string.length : max),
                0,
              );
              return (string) =>
                `${string}: ${" ".repeat(maxLength - string.length)}`;
            })(aAnnotation, bAnnotation);
          return `${
            printLabel(aAnnotation) +
            (function printExpected(value) {
              return f2.green(replaceTrailingSpaces(stringify(value)));
            })(getCommonAndChangedSubstrings(diffs, -1, hasCommonDiff2))
          }\n${
        ...
        let clonedExpected = deepClone(expected, { forceWritable: !0 }),
          clonedReceived = deepClone(received, { forceWritable: !0 }),
          { replacedExpected, replacedActual } = replaceAsymmetricMatcher(
            clonedExpected,
            clonedReceived,
          );
          ...
          ? (actualReplaced.has(actual) ||
              ...
              getOwnProperties(expected).forEach((key) => {
                ...
                if (isAsymmetricMatcher(expectedValue))
                  expectedValue.asymmetricMatch(actualValue) &&
                    (actual[key] = expectedValue);
                else if (isAsymmetricMatcher(actualValue))
                  actualValue.asymmetricMatch(expectedValue) &&
      ...
      function replaceTrailingSpaces(text) {
        return text.replace(/\s+$/gm, (spaces) => "·".repeat(spaces.length));
      }
      ...
      function serializeValue(val, seen = new WeakMap()) {
        ...
        if (
          (function isImmutable(v) {
            return (
              v &&
              (v["@@__IMMUTABLE_ITERABLE__@@"] || v["@@__IMMUTABLE_RECORD__@@"])
            );
          })(val)
        )
        ...
        if ("function" == typeof val.asymmetricMatch)
          return `${val.toString()} ${(function format2(...args) {
            if ("string" != typeof args[0]) {
              let objects = [];
              for (let i2 = 0; i2 < args.length; i2++)
                objects.push(inspect2(args[i2], { depth: 0, colors: !1 }));
              return objects.join(" ");
            }
            let len = args.length,
              i = 1,
              template = args[0],
              str = String(template).replace(formatRegExp, (x) => {
                if ("%%" === x) return "%";
                if (i >= len) return x;
                switch (x) {
                  case "%s": {
                    ...
                    return "bigint" == typeof value
                      ? `${value.toString()}n`
                      : "number" == typeof value && 0 === value && 1 / value < 0
                        ? "-0"
                        : "object" == typeof value && null !== value
                          ? inspect2(value, { depth: 0, colors: !1 })
                          : String(value);
                  }
                  case "%d": {
                    let value = args[i++];
                  ...
                  case "%i": {
                    ...
                    return "bigint" == typeof value
                      ? `${value.toString()}n`
                      : Number.parseInt(String(value)).toString();
                  }
                  case "%f":
                  ...
                  case "%j":
                    try {
                      ...
                      let m2 = err.message;
                      if (
                        m2.includes("circular structure") ||
                        m2.includes("cyclic structures") ||
                        m2.includes("cyclic object")
                      )
                        return "[Circular]";
                      throw err;
                    }
      ...
      function processError(_err, diffOptions, seen = new WeakSet()) {
        if (!_err || "object" != typeof _err) return { message: String(_err) };
        let err = _err;
        (err.stack && (err.stackStr = String(err.stack)),
          err.name && (err.nameStr = String(err.name)),
          (err.showDiff ||
            (void 0 === err.showDiff &&
              void 0 !== err.expected &&
              void 0 !== err.actual)) &&
          ...
          "string" != typeof err.expected &&
            (err.expected = stringify(err.expected, 10)),
          "string" != typeof err.actual &&
            (err.actual = stringify(err.actual, 10)));
        try {
          "string" == typeof err.message &&
            (err.message = (function normalizeErrorMessage(message) {
              return message.replace(
                /__(vite_ssr_import|vi_import)_\d+__\./g,
                "",
              );
            })(err.message));
        } catch {}
      ...
      var CallStates2,
        CallStates =
          (((CallStates2 = CallStates || {}).DONE = "done"),
        ...
        Instrumenter = class {
          constructor() {
            ((this.initialized = !1),
              ...
              (this.state =
                external_STORYBOOK_MODULE_GLOBAL_.global.window?.parent
            ...
            (this.channel.on(
              external_STORYBOOK_MODULE_CORE_EVENTS_.FORCE_REMOUNT,
              resetState,
            ),
              this.channel.on(
                external_STORYBOOK_MODULE_CORE_EVENTS_.STORY_RENDER_PHASE_CHANGED,
                ({ storyId, newPhase }) => {
              ...
              this.channel.on(
                external_STORYBOOK_MODULE_CORE_EVENTS_.SET_CURRENT_STORY,
                () => {
            ...
            (this.channel.on(EVENTS_START, start),
              this.channel.on(EVENTS_BACK, ({ storyId }) => {
              ...
              this.channel.on(EVENTS_GOTO, ({ storyId, callId }) => {
                let { calls, shadowCalls, resolvers } = this.getState(storyId),
                  call = calls.find(({ id }) => id === callId),
                  shadowCall = shadowCalls.find(({ id }) => id === callId);
                if (
                  !call &&
                  shadowCall &&
              ...
              this.channel.on(EVENTS_NEXT, ({ storyId }) => {
          ...
          setState(storyId, update) {
            ...
            ((this.state = {
              ...
              external_STORYBOOK_MODULE_GLOBAL_.global.window?.parent &&
                (external_STORYBOOK_MODULE_GLOBAL_.global.window.parent.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER_STATE__ =
                  this.state));
          }
          cleanup() {
          ...
          getLog(storyId) {
            let { calls, shadowCalls } = this.getState(storyId),
              merged = [...shadowCalls];
          ...
          instrument(obj, options, depth = 0) {
            ...
            let { mutate = !1, path = [] } = options,
              keys = options.getKeys
                ? options.getKeys(obj, depth)
                : Object.keys(obj);
            return (
              (depth += 1),
              keys.reduce(
                (acc, key) => {
                  let descriptor = (function getPropertyDescriptor(
                    obj,
                    propName,
                  ) {
                    let target = obj;
                  ...
                  return "function" != typeof value
                    ? ((acc[key] = this.instrument(
                        value,
                        { ...options, path: path.concat(key) },
                        depth,
                      )),
                      acc)
                    : "__originalFn__" in value &&
                        "function" == typeof value.__originalFn__
                      ? ((acc[key] = value), acc)
                      : ((acc[key] = (...args) =>
                          this.track(key, value, obj, args, options)),
          ...
          track(method, fn, object, args, options) {
            ...
            let id = `${ancestors.slice(-1)[0] || storyId} [${cursor}] ${method}`,
              ...
              result = (
                interceptable && !ancestors.length
                  ? this.intercept
                  : this.invoke
              ).call(this, fn, object, call, options);
          ...
          intercept(fn, object, call, options) {
            let { chainedCallIds, isDebugging, playUntil } = this.getState(
                call.storyId,
              ),
          ...
          invoke(fn, object, call, options) {
            let { callRefsByResult, renderPhase } = this.getState(call.storyId),
              serializeValues = (value, depth, seen) => {
                if (seen.includes(value)) return "[Circular]";
                if (((seen = [...seen, value]), depth > 25)) return "...";
                ...
                if (
                  value instanceof
                  external_STORYBOOK_MODULE_GLOBAL_.global.window?.HTMLElement
                ) {
                  let { prefix, localName, id, classList, innerText } = value;
                  return {
                    __element__: {
                      prefix,
                      localName,
                      ...
                      : "[object Object]" ===
                        ...
                        ? Object.fromEntries(
                            Object.entries(value).map(([key, val]) => [
                              key,
                              serializeValues(val, ++depth, seen),
                            ]),
                          )
                        : value;
              },
            ...
            let handleException = (e) => {
              if (e instanceof Error) {
                let { name, message, stack, callId = call.id } = e,
                  {
                    ...
                    actual,
                    expected,
                  } = "AssertionError" === e.name ? processError(e) : e,
                  exception = {
                    name,
                    message,
                    stack,
                ...
                if (
                  ...
                  throw (
                    Object.prototype.hasOwnProperty.call(e, "callId") ||
              ...
              let finalArgs = (
                  ...
                  "function" != typeof arg || Object.keys(arg).length
                    ...
                    : (...args) => {
                        ...
                        let restore = () =>
                            this.setState(call.storyId, { cursor, ancestors }),
                          willRestore = !1;
                        try {
                          let res = arg(...args);
          ...
          update(call) {
            (this.channel.emit(EVENTS_CALL, call),
              this.setState(call.storyId, ({ calls }) => {
                let callsById = calls
                  .concat(call)
                  .reduce((a2, c) => Object.assign(a2, { [c.id]: c }), {});
                return {
                  calls: Object.values(callsById).sort((a2, b) =>
                    a2.id.localeCompare(b.id, void 0, { numeric: !0 }),
                  ),
                };
              }),
          ...
          sync(storyId) {
            let synchronize = () => {
              let { isLocked, isPlaying } = this.getState(storyId),
      ...
      function instrument(obj, options = {}) {
        try {
          let forceInstrument = !1,
            skipInstrument = !1;
          return (
            external_STORYBOOK_MODULE_GLOBAL_.global.window?.location?.search?.includes(
              "instrument=true",
            )
              ? (forceInstrument = !0)
              : external_STORYBOOK_MODULE_GLOBAL_.global.window?.location?.search?.includes(
            ...
            skipInstrument
              ...
              : (external_STORYBOOK_MODULE_GLOBAL_.global.window &&
                  !external_STORYBOOK_MODULE_GLOBAL_.global.window
                    .__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__ &&
                  (external_STORYBOOK_MODULE_GLOBAL_.global.window.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__ =
                    new Instrumenter()),
                (external_STORYBOOK_MODULE_GLOBAL_.global.window?.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__).instrument(
                  obj,
                  options,
                ))
          );
      ...
      var dom_esm = __webpack_require__(
        ...
        debugOptions = { timeout: 2147483647, interval: 2147483647 },
        testingLibrary = instrument(__assign({}, dom_esm), {
          intercept: function (method, path) {
            return "fireEvent" === path[0] || method.startsWith("findBy");
          },
          getArgs: function (call, state) {
            ...
            if (call.method.startsWith("findBy")) {
              ...
              return [
                value,
                queryOptions,
                __assign(__assign({}, waitForOptions), debugOptions),
              ];
            }
      ...
      var templateObject_1,
        ...
        userEvent =
          ...
          instrument({ userEvent: dist.Ay }, { intercept: !0 }).userEvent);
    },
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/keyboard/getNextKeyDef.js"(
      ...
      function getErrorMessage(expected, found, text) {
        return `Expected ${expected} but found "${null != found ? found : ""}" in "${text}"\n    See https://github.com/testing-library/user-event/blob/main/README.md#keyboardtext-options\n    for more information about how userEvent parses your input.`;
      }
      (Object.defineProperty(exports, "__esModule", { value: !0 }),
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/keyboard/keyboardImplementation.js"(
      ...
      "use strict";
      (Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.keyboardImplementation = async function keyboardImplementation(
          text,
          options,
          state,
        ) {
          ...
          const { document } = options,
            ...
            { keyDef, consumedLength, releasePrevious, releaseSelf, repeat } =
          ...
          if (text.length > consumedLength || repeat > 1)
            return (
              ...
              keyboardImplementation(text.slice(consumedLength), options, state)
            );
          return;
        }),
      ...
      function applyPlugins(pluginCollection, keyDef, element, options, state) {
        ...
        return (
          plugin && plugin.handle(keyDef, element, options, state),
          !!plugin
        );
      }
    },
              ...
              newPos =
                ...
                (_ref =
                  selectionStart === selectionEnd
                    ? (null != selectionStart ? selectionStart : 0) + direction
                    : direction < 0
                      ? selectionStart
                      : selectionEnd)
                  ? _ref
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/keyboard/plugins/character.js"(
      ...
      const keypressBehavior = [
        ...
        },
        {
          matches: (keyDef, element) =>
            "Enter" === keyDef.key &&
            ((0, _utils.isElementType)(element, "textarea", { readOnly: !1 }) ||
              (0, _utils.isContentEditable)(element)) &&
            0 !== (0, _utils.getSpaceUntilMaxLength)(element),
          handle: (keyDef, element, options, state) => {
            const { newValue, newSelectionStart } = (0,
              ...
              inputType =
                (0, _utils.isContentEditable)(element) && !state.modifiers.shift
                  ? "insertParagraph"
                  : "insertLineBreak";
            (0, _shared.fireInputEvent)(element, {
              newValue,
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/keyboard/shared/fireInputEvent.js"(
        ...
        (exports.fireInputEvent = function fireInputEvent(
          ...
          ((function setSelectionRangeAfterInput(element, newSelectionStart) {
            ...
            (function setSelectionRangeAfterInputHandler(
              ...
              const value = (0, _utils.getValue)(element),
                isUnreliableValue =
                  "" === value && (0, _utils.hasUnreliableEmptyValue)(element);
      ...
      function applyNative(element, propName, propValue) {
        ...
        element[onBlur]) ||
          null == (_element$ownerDocumen = element.ownerDocument.defaultView) ||
      ...
      (Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.upload = function upload(
          ...
          if (
            ...
            throw new TypeError(
              `The ${input === element ? "given" : "associated"} ${null == input ? void 0 : input.tagName} element does not accept file uploads`,
            );
          if ((0, _utils.isDisabled)(element)) return;
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/utils/click/getMouseEventOptions.js"(
      ...
      const BUTTONS_NAMES = { none: 0, primary: 1, secondary: 2, auxiliary: 4 },
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/utils/edit/isValidDateValue.js"(
      ...
      "use strict";
      (Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.isValidDateValue = function isValidDateValue(element, value) {
    ...
    "./node_modules/@storybook/testing-library/node_modules/@testing-library/user-event/dist/utils/index.js"(
      ...
      Object.keys(_isLabelWithInternallyDisabledControl).forEach(
        function (key) {
          "default" !== key &&
            "__esModule" !== key &&
            ((key in exports &&
      ...
      (Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.isLabelWithInternallyDisabledControl =
          function isLabelWithInternallyDisabledControl(element) {
            if (!(0, _isElementType.isElementType)(element, "label")) return !1;
    ...
    "./node_modules/@testing-library/dom/dist/@testing-library/dom.esm.js"(
      ...
      const polyfills_SetLike = "undefined" == typeof Set ? Set : SetLike;
        ...
        return {
          ...
          serialize: (node, config, indentation, depth, refs, printer) => {
            ...
            return ++depth > config.maxDepth
              ...
              : ((type, printedProps, printedChildren, config, indentation) => {
                  const tagColor = config.colors.tag;
                  return (
                    tagColor.open +
                    "<" +
                  ...
                  type,
                  ((keys, props, config, indentation, depth, refs, printer) => {
                  ...
                  ((children, config, indentation, depth, refs, printer) =>
                    children
                      .map((child) => {
                        const printedChild =
                          "string" == typeof child
      ...
      const shouldHighlight = () => {
          ...
          return "boolean" == typeof colors
            ? colors
            : void 0 !== process.versions && void 0 !== process.versions.node;
        },
        { DOMCollection } = build.plugins;
      function filterCommentsAndDefaultIgnoreTagsTags(value) {
        return (
          8 !== value.nodeType &&
          (1 !== value.nodeType || !value.matches(getConfig().defaultIgnore))
        );
      }
      ...
      function getNodeText(node) {
        return node.matches(
          ...
          : Array.from(node.childNodes)
              .filter(
                (child) => 3 === child.nodeType && Boolean(child.textContent),
              )
              .map((c) => c.textContent)
              .join("");
      }
              ...
              attributes
                .map((_ref2) => {
                  ...
                  const shouldNotExist =
                      -1 !== constraints.indexOf("undefined"),
                    shouldBeNonEmpty = -1 !== constraints.indexOf("set");
                  return void 0 !== value
                    ? "[" + attributeName + '="' + value + '"]'
                    : shouldNotExist
                      ? ":not([" + attributeName + "])"
      ...
      const getMultipleError$7 = (c, text) =>
        ...
        queryAllByRole = function (container, role, _temp) {
          ...
          if (
            ...
            void 0 ===
              (null == (_allRoles$get = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== busy &&
            void 0 ===
              (null == (_allRoles$get2 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== checked &&
            void 0 ===
              (null == (_allRoles$get3 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== pressed &&
            void 0 ===
              (null == (_allRoles$get4 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== current &&
            void 0 ===
              (null == (_allRoles$get5 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== valueNow &&
            void 0 ===
              (null == (_allRoles$get6 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== valueMax &&
            void 0 ===
              (null == (_allRoles$get7 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== valueMin &&
            void 0 ===
              (null == (_allRoles$get8 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== valueText &&
            void 0 ===
              (null == (_allRoles$get9 = lib.Ot.get(role))
                ? void 0
          ...
          if (
            void 0 !== expanded &&
            void 0 ===
              (null == (_allRoles$get10 = lib.Ot.get(role))
                ? void 0
            ...
            container.querySelectorAll(
              (function makeRoleSelector(role) {
                ...
                const explicitRoleSelector = '*[role~="' + role + '"]',
                  roleRelations =
                    null != (_roleElements$get = lib.wZ.get(role))
                      ? _roleElements$get
                      : new Set(),
    ...
    "./node_modules/@testing-library/dom/node_modules/pretty-format/build/index.js"(
      ...
      var _ansiStyles = _interopRequireDefault(
          __webpack_require__("./node_modules/ansi-styles/index.js"),
        ),
              ...
              : "[object Set]" === toStringed
                ? hitMaxDepth
                  ...
                  : "Set {" +
                    ...
                    "}"
                : hitMaxDepth ||
                    ((val) => "undefined" != typeof window && val === window)(
                      val,
                    )
                  ? "[" + getConstructorName(val) + "]"
                  : (min
    ...
    "./node_modules/@testing-library/dom/node_modules/pretty-format/build/plugins/ConvertAnsi.js"(
      ...
      var _ansiRegex = _interopRequireDefault(
          __webpack_require__(
            "./node_modules/@testing-library/dom/node_modules/pretty-format/node_modules/ansi-regex/index.js",
          ),
        ),
    ...
    "./node_modules/@testing-library/dom/node_modules/pretty-format/build/plugins/ReactElement.js"(
      ...
      var ReactIs = (function _interopRequireWildcard(obj, nodeInterop) {
          ...
          __webpack_require__(
            "./node_modules/@testing-library/dom/node_modules/pretty-format/node_modules/react-is/index.js",
          ),
        ),
    ...
    "./node_modules/@testing-library/dom/node_modules/pretty-format/node_modules/react-is/cjs/react-is.production.min.js"(
      __unused_webpack_module,
      exports,
    ) {
      "use strict";
    ...
    "./node_modules/aria-query/lib/elementRoleMap.js"(
      ...
      (Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.default = void 0));
      var _lite = __webpack_require__("./node_modules/dequal/lite/index.js"),
      ...
      for (
        ...
        if (role)
          for (
            ...
            "HTML" === relation.module &&
              (function () {
                var concept = relation.concept;
                if (concept) {
                  var roles,
                    elementRoleRelation = elementRoles.find(
                      function (relation) {
          ...
          get: function get(key) {
            var item = elementRoles.find(function (tuple) {
              return (
                ...
                (0, _lite.dequal)(key.attributes, tuple[0].attributes)
              );
            });
            return item && item[1];
          },
    ...
    "./node_modules/aria-query/lib/etc/roles/ariaLiteralRoles.js"(
      ...
      var _alertRole = _interopRequireDefault(
        ...
        _markRole = _interopRequireDefault(
          __webpack_require__(
    ...
    "./node_modules/aria-query/lib/etc/roles/literal/presentationRole.js"(
      ...
      var _default = {
        ...
        relatedConcepts: [
          {
            concept: { attributes: [{ name: "alt", value: "" }], name: "img" },
            module: "HTML",
          },
        ],
        requireContextRole: [],
    ...
    "./node_modules/aria-query/lib/roleElementMap.js"(
      ...
      for (
        var roleElement = [], keys = _rolesMap.default.keys(), i = 0;
        i < keys.length;
        i++
      ) {
        var key = keys[i],
        ...
        if (role) {
          for (
            ...
            if ("HTML" === relation.module) {
              var concept = relation.concept;
              null != concept && relationConcepts.push(concept);
            }
          }
          relationConcepts.length > 0 &&
    ...
    "./node_modules/dequal/lite/index.js"(__unused_webpack_module, exports) {
      var has = Object.prototype.hasOwnProperty;
      exports.dequal = function dequal(foo, bar) {
        var ctor, len;
        if (foo === bar) return !0;
