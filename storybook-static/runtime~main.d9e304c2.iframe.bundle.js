(() => {
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({ 226: "Page-stories", 303: "Button-stories", 384: "Header-stories" })[
        chunkId
      ] || chunkId) +
      "." +
      {
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute("data-webpack") == "aconyte-arcade:" + key
            ) {
              script = s;
              break;
            }
        ...
        (script ||
          ...
          script.setAttribute("data-webpack", "aconyte-arcade:" + key),
          (script.src = url)),
          (inProgress[url] = [done]));
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkaconyte_arcade =
          self.webpackChunkaconyte_arcade || []);
