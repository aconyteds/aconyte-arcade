/*! For license information please see 356.1acc17ae.iframe.bundle.js.LICENSE.txt */
"use strict";
  ...
  [356],
  {
    ...
    "./node_modules/next/dist/compiled/react-dom/cjs/react-dom-client.production.js"(
      ...
      function claimNextTransitionLane() {
        ...
        return (
          !(4194048 & (nextTransitionLane <<= 1)) && (nextTransitionLane = 256),
          lane
        );
      }
      ...
      function findFirstSuspended(row) {
        for (var node = row; null !== node; ) {
          ...
          } else if (128 & node.flags) return node;
          if (node === row) break;
      ...
      function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        return showFallback
          ? (reuseSuspenseHandlerOnStack(),
            ...
            })).subtreeFlags = 65011712 & prevState.subtreeFlags),
            null !== digest
      ...
      function updateSuspenseListComponent(
        ...
        var suspenseContext = suspenseStackCursor.current,
          shouldForceFallback = !!(2 & suspenseContext);
        if (
          (shouldForceFallback
      ...
      function beginWork(current, workInProgress, renderLanes) {
                ...
                (function attemptEarlyBailoutIfNoScheduledUpdate(
                  ...
                  switch (workInProgress.tag) {
                    ...
                    case 13:
                      ...
                      if (null !== state$101)
                        return null !== state$101.dehydrated
                          ? (pushPrimaryTreeSuspenseHandler(workInProgress),
                            (workInProgress.flags |= 128),
                            null)
                          : 0 !==
        ...
        switch (((workInProgress.lanes = 0), workInProgress.tag)) {
          ...
          case 10:
            return (
              (props = workInProgress.pendingProps),
              pushProvider(0, workInProgress.type, props.value),
              reconcileChildren(
                current,
                workInProgress,
                props.children,
        ...
        if (didBailout)
          for (var child$106 = completedWork.child; null !== child$106; )
            ((newChildLanes |= child$106.lanes | child$106.childLanes),
              (subtreeFlags |= 65011712 & child$106.subtreeFlags),
              (subtreeFlags |= 65011712 & child$106.flags),
          ...
          case 19:
            ...
            return null !== newProps.tail
              ? ((current = newProps.tail),
                ...
                push(
                  suspenseStackCursor,
                  type ? (1 & renderLanes) | 2 : 1 & renderLanes,
                ),
                isHydrating &&
                  pushTreeFork(workInProgress, newProps.treeForkCount),
                current)
        ...
        try {
          ...
          (!(function updateProperties(domElement, tag, lastProps, nextProps) {
            switch (tag) {
              ...
              case "textarea":
                for (defaultValue in ((propKey = propKey$200 = null),
                lastProps))
                  if (
                ...
                return void updateTextarea(domElement, propKey$200, propKey);
              case "option":
                for (var propKey$216 in lastProps)
                  if (
                    ...
                    if ("selected" === propKey$216) domElement.selected = !1;
                    else
                      setProp(
                        domElement,
                        tag,
                        ...
                        case "link":
                          ...
                          if (maybeNodes)
                            for (var i = 0; i < maybeNodes.length; i++)
                              if (
                                (currentResource = maybeNodes[i]).getAttribute(
                                  "href",
                                ) ===
                  ...
                  if (null === current) {
                    ...
                    try {
                      if (
                        ...
                        "function" ==
                        typeof (maybeNodes = currentResource.style).setProperty
        ...
        if (1024 & parentFiber.subtreeFlags)
          for (parentFiber = parentFiber.child; null !== parentFiber; ) {
            ...
            (recursivelyResetForms(fiber),
              5 === fiber.tag && 1024 & fiber.flags && fiber.stateNode.reset(),
              (parentFiber = parentFiber.sibling));
          }
      }
            ...
            try {
              !(function commitBeforeMutationEffects(root, firstChild) {
                if (
                  ...
                  hasSelectionCapabilities((root = getActiveElementDeep(root))))
                ) {
      ...
      function flushSyncWorkAcrossRoots_impl(syncTransitionLanes, onlyLegacy) {
        if (!isFlushingWork && mightHavePendingSyncWork) {
          ...
          do {
            for (
              var didPerformSomeWork = !1, root$169 = firstScheduledRoot;
              null !== root$169;
            ) {
              if (!onlyLegacy)
                ...
                b: {
                  for (
                    inCapturePhase = getParent,
                      ...
                      lastHostComponent = 0,
                      _instance = reactEventName = SyntheticEventCtor;
                    _instance;
            ...
            if (isCustomElement(tag)) {
              for (propValue$183 in props)
                props.hasOwnProperty(propValue$183) &&
                  void 0 !== (hasSrc = props[propValue$183]) &&
                  setPropOnCustomElement(
                    domElement,
                    tag,
                    propValue$183,
              ...
              return (
                ...
                (styleProps = hoistableRoot.querySelector(
                  ...
                  ? ((resource.instance = styleProps),
                    ...
                    styleProps)
                  : ((instance = props),
                    (styleProps = preloadPropsMap.get(instance$248)) &&
      ...
      function insertStylesheetIntoRoot(root, resource) {
        if (!(4 & resource.state.loading)) {
          ...
          ((node = (nodes = resource.instance).getAttribute("data-precedence")),
