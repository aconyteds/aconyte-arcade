  ...
  return (
    <Container>
      ...
      <Row className="justify-content-center">
        <Col xs="auto">
          <p>
            Welcome to Aconyte&rsquo;s Arcade! Please enjoy your time purusing
            the games below.
          </p>
        </Col>
      </Row>
        ...
        <Col>
          <Card onClick={launchWordGame} className="cursor-pointer shadow">
            ...
            <Card.Body>
              ...
              <ol>
                <li>
                  <span className="text-success">Green</span> background means
                  the character is in the correct place.
                </li>
                <li>
                  <span className="text-warning">Yellow</span> background means
                  the character is in the word, but not the right place.
                </li>
                <li>
